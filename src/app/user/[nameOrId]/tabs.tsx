...
export function UserTabs({ userId }: { userId: number }) {
  ...
  const { data: top5 } = trpc.user.top5Scores.useQuery(
    { userId, limit },
    {
      enabled: tab === "top-5",
    },
  );
  const { data: recent } = trpc.user.recentScores.useQuery(
    { userId, limit },
    {
      enabled: tab === "recent",
    },
        ...
        <div className="flex items-center gap-5 justify-between">
          ...
          >
            <SelectTrigger className="max-w-[100px]">
              <SelectValue>Show {limit.toString()}</SelectValue>
            </SelectTrigger>
            <SelectContent>
              ...
              return (
                ...
                >
                  <div className="flex flex-col">
                    <Link
                      href={`/beatmap/${score?.beatmapId}#osu/${beatmap?.beatmapSetId}`}
                      target={"_blank"}
